...
namespace SA3D.Common.Converters
{
	...
	public class UInt8HexConverter : TypeConverter
	{
		...
		{
			if(destinationType == typeof(string) && value is byte integer)
			{
		...
		/// <summary>
		/// Converts an unsigned 8-bit integer to a hexadecimal string value
		/// </summary>
		/// <param name="value"></param>
		/// <returns></returns>
		public static string ConvertTo(byte value)
		{
		...
		/// <summary>
		/// Converts a hexadecimal string value to an unsigned 8-bit integer
		/// </summary>
		/// <param name="value">The value to convert</param>
		/// <param name="debugName">Name by which to identify the value being converted</param>
		/// <returns></returns>
		public static byte ConvertFrom(string value, string? debugName = null)
		{
